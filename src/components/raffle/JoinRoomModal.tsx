...
import { ShieldCheck, Clock, Loader2, Ticket, Copy, CheckCircle2 } from 'lucide-react';
          ...
          <>
            ...
            <DialogFooter className="flex flex-col gap-2 sm:flex-col">
              <Button 
                ...
                className="w-full premium-gradient h-14 rounded-2xl font-black text-lg mt-4"
              >
              ...
              <Button 
                variant="ghost" 
                onClick={onClose} 
                className="w-full h-12 text-white/20 font-black text-[10px] uppercase"
              >
                Cancelar
              </Button>
            </DialogFooter>
