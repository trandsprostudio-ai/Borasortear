  ...
  return (
    <div className="min-h-screen bg-[#0A0B12] text-white font-sans pb-24">
      ...
      <main className="max-w-[1600px] mx-auto px-4 pt-8 md:pt-12 pb-20">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-12 bg-[#151823]/80 backdrop-blur-xl border border-white/10 p-6 md:p-8 rounded-[2rem]">
          <PrizeCarousel />
          ...
          <div className="flex items-center gap-3">
            ...
            <Button onClick={() => navigate('/central-de-ajuda')} variant="ghost" className="text-white/40 font-black text-[10px] uppercase">
              AJUDA
            </Button>
          </div>
        </div>
        ...
        <section className="mb-16">
          <div className="flex items-center gap-3 mb-8">
            <div className="w-10 h-10 md:w-12 md:h-12 bg-purple-600 rounded-2xl flex items-center justify-center text-white">
              <Activity size={24} />
            </div>
            <div>
              <h2 className="text-2xl md:text-3xl font-black italic uppercase">SALAS AO VIVO</h2>
              <p className="text-[10px] font-bold text-white/20 uppercase tracking-[0.2em]">Sorteios Estilo Bet</p>
            </div>
          </div>
          ...
          <div className="flex gap-2 mb-10 overflow-x-auto no-scrollbar pb-2">
            {modules.map((mod) => (
              <Button
                ...
                className={`h-12 px-6 rounded-2xl font-black text-[10px] md:text-xs uppercase shrink-0 ${
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            <div className="bg-[#151823]/50 border border-white/5 rounded-[2.5rem] p-6 md:p-8">
